...
L["Must be between level %d-%d (+/- 6 level)"] = true
...
L["%s Write your review in the Guildfound AH Addon"] = true
...
L["Gnomeregan"] = true
L["Guildfound AH"] = true
L["Guildfound AH - %s's Auctions"] = true
L["Gold"] = true
...
L["Seller"] = true
L["Set your requirements for who can play with you through the finder feature"] = true
...
L["This player has set certain level requirements"] = true
L["Tip"] = true
L["Tip (%d%%)"] = true
L["Tip (0%)"] = true
L["Trade"] = true
