...
L_REVIEWS = L["Reviews"]
L_DUNGEON_FINDER = L["Dungeon Finder"]
...
L_NO_MIN = L["No Min"]
L_NO_MAX = L["No Max"]
L_APPLY_FILTER = L["Apply Filter"]
L_BLOCK_USERS = L["Block Users"]
L_COLAB_SET_REQUIREMENTS = L["Set your requirements for who can play with you through the finder feature"]

local GuildfoundAH = L["Guildfound AH"]
L_GO_AGAIN_BROWSE_AUCTIONS = GuildfoundAH .. " - " .. L["Browse Auctions"]
L_GO_AGAIN_PENDING_ORDERS = GuildfoundAH .. " - " .. L["Pending Orders"]
